...
public class UsersDaoImpl implements UsersDao {
	 ...
	 */
	 public UsersDto getUser(long userId, SqlSession session) throws RyzaDBException {
		 try{
	...
	@Override
	 public List<UsersDto> getUserList(SqlSession sqlSession) throws RyzaDBException {
		try {
